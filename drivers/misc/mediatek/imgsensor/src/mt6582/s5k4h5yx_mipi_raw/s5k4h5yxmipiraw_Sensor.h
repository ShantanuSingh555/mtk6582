...
typedef struct
{
	...
	#define S5K4H5YX_FULL_X_START						    		(0)
	#define S5K4H5YX_FULL_Y_START						    		(0)
	#define S5K4H5YX_PV_X_START						    		(0)
	#define S5K4H5YX_PV_Y_START						    		(0)
	#define S5K4H5YX_VIDEO_X_START								(0)
	#define S5K4H5YX_VIDEO_Y_START								(0)
	...
	#define S5K4H5YX_FULL_PERIOD_PIXEL_NUMS					(3688) 
	#define S5K4H5YX_FULL_PERIOD_LINE_NUMS					(2512)
	...
	#define S5K4H5YX_PV_PERIOD_LINE_NUMS					(2512)	

	#define S5K4H5YX_VIDEO_PERIOD_PIXEL_NUMS 				(3688)
	#define S5K4H5YX_VIDEO_PERIOD_LINE_NUMS					(2512)
...
#define S5K4H5YXMIPI_WRITE_ID 	(0x6C) //(0x20)
