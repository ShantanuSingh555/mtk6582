...
#define S5K4H5YX_TEST_PATTERN_CHECKSUM (0xe6828796)

kal_uint32 s5k4h5yx_video_frame_length = 2512;
kal_uint32 s5k4h5yx_video_line_length = 3688;
kal_uint32 s5k4h5yx_preview_frame_length = 2512;
kal_uint32 s5k4h5yx_preview_line_length = 3688;
kal_uint32 s5k4h5yx_capture_frame_length =2512;
kal_uint32 s5k4h5yx_capture_line_length = 3688;
...
kal_uint32 cont_preview_frame_length = 2512;
kal_uint32 cont_capture_line_length = 3688;
kal_uint32 cont_capture_frame_length = 2512;

kal_uint32 cont_video_frame_length = 2512;
...
void S5K4H5YXPreviewSetting(void)
{
  ...
  S5K4H5YX_write_cmos_sensor(0x0203, 0xC0);
  ...
  S5K4H5YX_write_cmos_sensor(0x3300, 0x01);
  S5K4H5YX_write_cmos_sensor(0x3000, 0x07);
  ...
  //LSC
  S5K4H5YX_write_cmos_sensor(0x3300, 0x00);
}
...
UINT32 S5K4H5YXOpen(void)
{
	...
	s5k4h5yx.pvPclk =  (28000);  
	s5k4h5yx.videoPclk = (28000); 
...
UINT32 S5K4H5YXGetResolution(MSDK_SENSOR_RESOLUTION_INFO_STRUCT *pSensorResolution)
{
    ...
    pSensorResolution->SensorPreviewHeight	= 1232;
	pSensorResolution->SensorFullWidth		= 3264;
    pSensorResolution->SensorFullHeight		= 2464;
                                                ...
                                                MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
	...
	pSensorInfo->SensorPreviewResolutionY= 1232;
	pSensorInfo->SensorFullResolutionX= 3264;
    pSensorInfo->SensorFullResolutionY= 2464;
...
//<2015/01/19-joubert.she-[V10][Bug][Common][BSP][][] camera colour abnormal bug issue fix
   		pSensorInfo->SensorOutputDataFormat= SENSOR_OUTPUT_FORMAT_RAW_Gr; //Gb r
//>2015/01/19-joubert.she
...
{ 
		S5K4H5YXDB("[S5K4H5YXSetTestPatternMode] Test pattern enable:%d\n", bEnable);	 
